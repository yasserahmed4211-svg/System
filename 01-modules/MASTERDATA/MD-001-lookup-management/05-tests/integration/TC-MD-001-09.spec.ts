...
const KNOWN_VALID_CODE    = 'ASSET';      // From seeded GL_ACCOUNT_TYPE details
...
test.describe('G9 — Cross-Module: LookupValidationApi', () => {
  ...
  test('[TC-056] [BUG-04] isValid proxy — known code ASSET appears in GL_ACCOUNT_TYPE values; Redis DOWN → 500', async () => {
